  ...
  return (
    <div className="flex flex-col w-full h-full bg-landing bg-no-repeat bg-cover">
      ...
      <header className="h-1/3">
        <img className="w-24 mt-6 ml-6 md:w-20 md:ml-8" src={logo} alt="" />
      </header>

      <div className="flex flex-col h-2/3 mx-4 md:ml-32 md:mt-16 md:w-1/4">
        <h1 className="text-5xl font-semibold mb-4">Connecting Chefs to Kitchen Spots</h1>
